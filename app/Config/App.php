...
class App extends BaseConfig
{
     ...
     */
    public string $baseURL; // DIINISIALISASI DI KONSTRUKTOR
     ...
     * @var list<string>
     */
    public array $allowedHostnames = []; // BISA TETAP DIBIARKAN KOSONG JIKA TIDAK DARI ENV
     ...
     */
    public string $indexPage; // DIINISIALISASI DI KONSTRUKTOR
    ...
    */
     ...
     */
    public bool $forceGlobalSecureRequests; // DIINISIALISASI DI KONSTRUKTOR
     ...
     */
    public array $proxyIPs; // DIINISIALISASI DI KONSTRUKTOR (dengan IP Koyeb)
    ...
    // KONSTRUKTOR UNTUK INISIALISASI PROPERTI DARI ENVIRONMENT VARIABLES
    public function __construct()
    {
        ...
        $this->indexPage = env('APP_INDEXPAGE', 'index.php');
